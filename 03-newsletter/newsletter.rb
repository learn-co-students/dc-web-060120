...
CAMPUS = {
  :name => "DC",
  :address => "Addresses were from the before time"
}
...
def calculate_recipients
  ...
  # take the subscribers, put all the ones that are not in unsubscribers into a new array
...
def print_many_articles(articles)
  ...
  # and format each one using the format_article method
